...
try:
    def paralel_process(host, result, time_count, command_status, phone_number):
        ...
        while True:
            ...
            for i in range(1, 10, 1):
                ...
                if host == "85.132.61.82":
                    hostname = "Delta"
                elif host == "109.235.197.86":
            ...
            if (f / i) * 100 > 40:  # If loss is greater than 40 percent
                time_count += 1
            ...
            if datetime.today().day == 1:
                if datetime.now().strftime("%H:%M") == "10:30":
    ...
    if __name__ == '__main__':
        ...
        result = mp.Queue()
        processes = [mp.Process(target=paralel_process, args=(host, result, time_count, command_status, phone_number)) for host in ["85.132.61.82", "109.235.197.86"]]
